...
<c:url value="/users/mysql" var="mysqlUrl" />
...
<body>
	...
	<div id='controlBar'>
		<input type='button' value='debugORM' id='debugORM' /> <input
			type='button' value='New' id='newBtn' /> <input type='button'
		...
		<form>
			<fieldset>
				...
				<label for='newUsername'>Username</label><input type='text'
					...
					for='newRole'>Role</label> <select id='newRole'>
